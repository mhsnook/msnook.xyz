...
values
	...
	(
		...
		null,
		1,
		'Infectious diseases, conditions related to pregnancy/birth, and malnutrition'
	),
	(
		200,
	...
	(
		...
		null,
		3,
		'Deaths from external causes including violence, accidents, and self-harm'
	),
	...
	(
		...
		100,
		1,
		'Includes HIV/AIDS, syphilis, chlamydia, gonorrhea, and other STIs'
	),
	(
		102,
		...
		100,
		2,
		'Lower respiratory infections, upper respiratory infections, tuberculosis'
	),
	(
		103,
		'Enteric infections',
		...
		100,
		3,
		'Diarrheal diseases, typhoid, paratyphoid, and other intestinal infections'
	),
	(
		104,
		...
		100,
		4,
		'Malaria, dengue, Chagas, leishmaniasis, schistosomiasis, and others'
	),
	(
		105,
		...
		100,
		5,
		'Meningitis, encephalitis, hepatitis, and other infections not elsewhere classified'
	),
	(
		106,
		...
		100,
		6,
		'Maternal hemorrhage, sepsis, hypertensive disorders; neonatal preterm, encephalopathy, sepsis'
	),
	(
		107,
		...
		100,
		7,
		'Protein-energy malnutrition, iron deficiency, vitamin A deficiency, iodine deficiency'
	),
	...
	(
		...
		200,
		1,
		'All cancers: lung, breast, colorectal, stomach, liver, cervical, etc.'
	),
	(
		202,
		...
		200,
		2,
		'Ischemic heart disease, stroke, hypertensive heart disease, cardiomyopathy'
	),
	(
		203,
		...
		200,
		3,
		'COPD, asthma, pneumoconiosis, interstitial lung disease'
	),
	(
		204,
		'Digestive diseases',
		...
		200,
		4,
		'Cirrhosis, peptic ulcer, inflammatory bowel disease, pancreatitis, gallbladder disease'
	),
	(
		205,
		...
		200,
		5,
		'Alzheimer, Parkinson, epilepsy, multiple sclerosis, motor neuron disease'
	),
	(
		206,
		'Mental disorders',
		...
		200,
		6,
		'Eating disorders and some direct mortality; most mental health burden is disability not death'
	),
	(
		207,
		...
		200,
		7,
		'Alcohol use disorders, drug use disorders (opioid, cocaine, amphetamine, etc.)'
	),
	(
		208,
		...
		200,
		8,
		'Diabetes mellitus types 1 and 2, chronic kidney disease'
	),
	(
		209,
		...
		200,
		9,
		'Dermatitis, psoriasis, cellulitis, scabies — very low direct mortality'
	),
	(
		210,
		...
		200,
		10,
		'Hearing loss, vision loss — negligible direct mortality, major disability burden'
	),
	(
		211,
		...
		200,
		11,
		'Low back pain, osteoarthritis, rheumatoid arthritis — negligible direct mortality'
	),
	(
		212,
		...
		200,
		12,
		'Congenital anomalies, hemoglobinopathies, endocrine disorders, oral conditions'
	)
...
values
	(
		...
		300,
		1,
		'Road injuries, pedestrian, cyclist, motorcyclist, and other transport deaths'
	),
	(
		302,
		...
		300,
		2,
		'Falls, drowning, fire/heat, poisoning, exposure to mechanical forces, natural disasters'
	),
	(
		303,
		...
		300,
		3,
		'Suicide, homicide by firearm/sharp object/other means, sexual violence, conflict/terrorism'
	)
on conflict (id) do nothing;
...
-- =============================================================================
insert into
	mortality.super_regions (id, name, slug, sort_order)
values
	(
		1,
...
values
	...
	(
		...
		'estimated',
		'GBD 2019 approx',
		'Global-level estimate applied to region'
	),
	(
		105,
		2,
	...
	(
		...
		'estimated',
		'GBD 2019 approx',
		'Direct mortality only; disability burden much higher'
	),
	(
		206,
		2,
...
values
	...
	(
		...
		2019,
		true,
		'Near-zero HIV in Japan/Korea/Singapore'
	),
	(
		102,
		'Australasia',
		...
		2019,
		true,
		'Low TB burden, good respiratory care'
	),
	(
		103,
		...
		2019,
		true,
		'Clean water, sanitation, healthcare access'
	),
	(
		104,
	...
	(
		...
		2019,
		true,
		'Good infectious disease control'
	),
	(
		106,
		'High-income Asia Pacific',
		...
		2019,
		true,
		'Excellent maternal/neonatal care in Japan'
	),
	(
		107,
		'High-income Asia Pacific',
	...
	(
		...
		2019,
		true,
		'Younger population caveat; not necessarily best care'
	),
	(
		202,
		'High-income Asia Pacific',
		...
		2019,
		true,
		'Japan: diet, healthcare, low smoking (declining)'
	),
	(
		203,
		'Central/Southern Latin America',
		4,
		15.0,
		2019,
		true,
		'Low COPD, less indoor air pollution'
	),
	(
		204,
		'Australasia',
		...
		2019,
		true,
		'Lower alcohol-related liver disease'
	),
	(
		205,
		'Central Sub-Saharan Africa',
		...
		2019,
		true,
		'Lower rates partly reflect younger population'
	),
	(
		206,
		'Multiple regions',
		...
		2019,
		true,
		'Negligible direct mortality everywhere'
	),
	(
		207,
		'High-income Asia Pacific',
	...
	(
		...
		2019,
		true,
		'Good diabetes management, lower obesity'
	),
	(
		209,
		'High-income Asia Pacific',
	...
	(
		...
		2019,
		true,
		'Good management of congenital conditions'
	),
	-- Injury causes
	(
		301,
		'Western Europe/Hi-income AP',
		7,
		5.0,
		2019,
		true,
		'Strong road safety laws, infrastructure, enforcement'
	),
	(
		302,
		...
		2019,
		true,
		'Safety regulations, building codes, rescue services'
	),
	(
		303,
		'North Africa and Middle East',
		...
		2019,
		true,
		'Very low homicide and lower suicide; data quality caveat'
	);
