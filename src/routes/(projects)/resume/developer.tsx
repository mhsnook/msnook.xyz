...
import PictureSection from '@/components/resume-developer/picture-section'
import { Wrapper, LeftContainer, RightContainer } from '@/components/resume-developer/containers'
import {
	SkillsDeveloper,
		...
		<>
			<Wrapper>
				...
				<RightContainer>
					...
					<h2 className="text-2xl font-bold font-display">Recent Projects (Lead Developer)</h2>
				...
				<div className="col-span-4 md:px-10 py-12 mt-2 text-md">
					...
					<div className="md:columns-2 space-y-8 gap-8">
						<div className="space-y-6">
							...
							/>
							<p>
								At VoteAmerica I was called in to be the Product Manager for the last 4 months of
								the election cycle. We had a team of about 6 Engineers working on a national system
								of form-helpers and reminders and everything we could think to achieve one clear
								goal: to help voters look up their registration, request an absentee ballot, or get
								help with their voting journey. Our product motto was:{' '}
							</p>
							<blockquote className="italic border-l-4 px-4 md:pr-8">
								The best Voter Experience allowed by law in all 50 states and the District of
								Columbia.
							</blockquote>
							<p>
								When Election Day got closer and we launched our campaign to send 100 Million text
								messages to voters across the country, the outreach team came to us for help with
								their data pipeline. Since election day was about 6 weeks away, most of the product
								was already managed, so I put on another hat and built the SQL pipeline that
								selectively merged high-quality updates from upstream data vendors, selected the
								most likely phone number for each household (or the most likely voter identity for a
								#) and built the priority lists for each state on a rolling/nightly basis.
							</p>
							<p>
								And I had the pleasure to manage an experiment in a truly new way of doing voter
								outreach: a system called The Voter Helpline which received the SMS{' '}
								<em>responses</em> from our outreach program and funneled them into different
								channels in a Slack team, where our legal assistance volunteers would claim the
								conversation and chat with the voter until their question was answered. The
								volunteer never had to leave Slack and the voter never had to leave their SMS. It
								was a dream for engagement and contact completion, and I think it helped a lot of
								people.
							</p>
							<Alert>
								Our main tools at VoteAmerica were React, Gatsby, Django Rest Framework, with
								Cloudflare Workers for PDFs and Faxes, Bulma for CSS and Redshift and the Civis
						...
						<div className="space-y-6">
							...
							/>
							<p>
								The OPEN is a networking body that works with around 20 organisations from 20
								different countries to help them share knowledge, engage in collaborations, and
								provide both material and moral support across countries, borders and cultures.
							</p>
							<p>
								During my 6 years leading the tech team, we helped over a dozen organisations put
								their tech team and stack together to launch, and then scale and hire, refactor or
								pivot, and more. By the end of my time there we were managing multiple shared-source
								products that were used across the network for our members&apos; critical business
								concerns, like sending mass communications to members and receiving donations.
							</p>
							<p>
								And I got to facilitate some of the most incredible events of my career: the annual
								tech summit, where every organisation would send their tech director and maybe one
								or two other staff and we&apos;d get about 50 people together in a conference center
								for a week and talk and share and hack and ask for help and share our plans for the
								future and see where the overlaps cropped up. So the job was part tech management
								and, on some levels, part diplomacy. I loved the relational aspect of the job, but
								it was also highly political and so eventually I burned out and decided to take my
								career toward the &ldquo;individual contributor&rdquo; role as a product manager.
							</p>
							<Alert>
								The tools we maintained at OPEN mostly used Rails, React, Express, Wordpress,
								jQuery, Bootstrap, Docker, Kubernetes, Postgres – and the unstoppable power of
								collaboration!
							</Alert>
						</div>
						<div className="space-y-6">
							...
							/>
							<p>
								I started at BoldProgressives.org as the first employee, as a data manager and
								digital production manager, basically building and targeting emails and landing
								pages. When we decided to build out a web team to make more of our own organizing
								tools and take control of our most key workflows, I had the job of planning, hiring
								and managing it.
							</p>
							<p>
								It was a crash course in technical management as well as organisational management.
								As one of the trusted early staffers I was thrown into so many different situations
								like managing a TV ad shoot, or flying out to help a campaign set up a door-to-door
								volunteer operation and integrate the national voter database with their work, or
								taking donor meetings with foundations, or advising the founders on org structure as
								we scaled and adapted.
							</p>
							<p>
								And even after six years there and running a department, there were still times
								we&apos;d be on deadline and I&apos;d jump in to write SQL to target an email or
								double-check that a page had been built correctly (some things never change).
							</p>
							<Alert>
								We used a SAAS platform called ActionKit with our own Django templates, loads of
								jQuery, MySQL for targeting and Analytics, Bootstrap for styles, and a handful of
								Django apps and admins.
							</Alert>
							<br />
						</div>
					</div>
