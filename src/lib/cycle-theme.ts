...
export const dailyTitles: Record<PhaseNumber, string[]> = {
	...
	2: [
		...
		'Follow the thread. Dig into whatever has momentum.',
		'Mid-week check-in: building what you planned, or something better?',
		'Keep pushing. Small wins compound.',
		'Try the weird idea. Today is for exploration.',
		'Tie up loose threads. What surprised you this week?',
		'Breathe. Let the week settle before you push again.',
	],
	3: [
		'Full power. What\u2019s actually going to ship?',
		'Focus and prune. Defer what\u2019s off-track gracefully.',
		'Deep work. Protect your hours.',
		'Polish the details. They matter now.',
		'Ship what\u2019s ready. Done beats perfect.',
		'Last push before harvest. Tie up what you can.',
		'Pause. Almost there. Recharge for the home stretch.',
	],
	4: [
		'Harvest time. What ripened? Bring it in.',
		'Ship everything ready. No more polishing.',
		'Retro: what worked, what didn\u2019t? Be honest.',
		'Defer the rest. \u201CNot this cycle\u201D is a complete sentence.',
		'Close out. Update boards, notes, docs.',
		'Tweak your rituals. Small adjustments, not overhauls.',
		'Rest. New cycle tomorrow.',
	],
}
...
export const phaseRituals: Record<PhaseNumber, string[]> = {
	...
	2: [
		...
		'Activity aligns with stated intentions for this revolution',
	],
	3: [
		'Tuesday showcase',
		'Identify what is shipping this revolution',
	...
	4: [
		...
		'Amend rituals if needed (takes effect next revolution)',
		'After Thursday: rest',
	],
}
