				...
				<div className="max-w-lg w-full text-center space-y-8">
					...
					>
						<p
							...
							style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}
						>
							Let it be known that on this day, by the power vested in this
							website by absolutely no one, the following parties have entered
							into the sacred bond of marriage by clicking buttons on the
							internet.
						</p>
							...
							<div className="pt-4 space-y-4 animate-in fade-in duration-500">
								...
								<div className="flex justify-center">
									<div
										...
										style={{
											boxShadow:
												'0 0 0 2px white, 0 0 0 4px var(--color-cyan-bright)',
										}}
									>
										<span className="text-cyan-bright text-4xl font-bold">
											&#10003;
										</span>
										<span
								...
								<p className="text-gray-300 text-xs pt-4">
									This certificate is not legally binding in any jurisdiction,
									dimension, or timeline. But it&rsquo;s still nice.
								</p>
							</div>
						)}
					</div>
