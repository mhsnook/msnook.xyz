...
export default function PictureSection({ link }: { link: string }) {
	return (
		<div className="text-center flex flex-col gap-1">
			...
			<div className="mx-auto">
				<a className="hover:link" href="mailto:me@msnook.xyz">
					me@msnook.xyz
				</a>
				<a className={linkClasses} href="https://github.com/mhsnook">
					<OctocatIcon /> mhsnook
				</a>
				<a className={linkClasses} href="https://wa.me/14348824164">
					<WhatsappIcon /> +1 434 8824164
				</a>
				<a className={linkClasses} href="tel:+919880742084">
